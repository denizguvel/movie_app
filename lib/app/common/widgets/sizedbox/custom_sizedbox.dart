...
class CustomSizedbox extends StatelessWidget {
  ...
  const CustomSizedbox.expand(double mainAxisExtent, {Key? key, Color? color})
    : this(
        mainAxisExtent,
        key: key,
...
class _RawCustomSizedbox extends LeafRenderObjectWidget {
  const _RawCustomSizedbox(
    this.mainAxisExtent, {
    this.crossAxisExtent,
    this.color,
  ...
  void updateRenderObject(
    ...
    RenderCustomSizedbox renderObject,
  ) {
    renderObject
      ..mainAxisExtent = mainAxisExtent
      ..crossAxisExtent = crossAxisExtent ?? 0
...
class RenderCustomSizedbox extends RenderBox {
  RenderCustomSizedbox({
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    ...
    if (direction != null) {
      ...
      throw FlutterError(
        'A CustomSizedbox widget must be placed directly inside a Flex widget '
